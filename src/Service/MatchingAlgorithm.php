...
{
    public function getExactAllOffers(int $candidate_id, ManagerRegistry $managerRegistry): array
    {
    ...
    public function getExactFreeOffers(int $candidate_id, ManagerRegistry $managerRegistry): array
    {
        $entityManager = $managerRegistry->getManager();
        $candidateRepository = $entityManager->getRepository(Candidate::class);
        $candidate = $candidateRepository->find($candidate_id);
